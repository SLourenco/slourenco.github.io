...
![Image with initial search step: checking closes centroid](/docs/assets/vector-database-demo/vector-database-index-1.png)

On that cluster, all vectors are processed for our search query.

![Image with second search step: brute force on cluster](/docs/assets/vector-database-demo/vector-database-index-2.png)
